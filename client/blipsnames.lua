...
RegisterNetEvent('qb-admin:client:toggleBlips', function()
    if not ShowBlips then
        ShowBlips = true
        NetCheck1 = true
        exports['okokNotify']:Notify("Blips activated", "success")
    else
        ShowBlips = false
        exports['okokNotify']:Notify("Blips deactivated", "error")
    end
end)
...
RegisterNetEvent('qb-admin:client:toggleNames', function()
    if not ShowNames then
        ShowNames = true
        NetCheck2 = true
        exports['okokNotify']:Notify("Names activated", "success")
    else
        ShowNames = false
        exports['okokNotify']:Notify("Names deactivated", "error")
    end
end)
